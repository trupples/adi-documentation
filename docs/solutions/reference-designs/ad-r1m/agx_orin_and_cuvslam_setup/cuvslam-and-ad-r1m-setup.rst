...
.. figure:: /solutions/reference-designs/ad-r1m/agx_orin_and_cuvslam_setup/cuvslam_orin_setup/Robot_power_connection.jpg
        :alt: Barrel connection to robot battery
        :align: center
        :width: 600px

.. figure:: /solutions/reference-designs/ad-r1m/agx_orin_and_cuvslam_setup/cuvslam_orin_setup/Robot_ethernet_connection.jpg
...
.. note::
    * You can use as multiple RealSense cameras without modifying the launch script. Simply configure each camera's serial number in **vslam_single_realsense.yaml** and set the corresponding transform in **single_realsense_calibration.urdf**.
